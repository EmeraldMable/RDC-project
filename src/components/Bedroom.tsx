...
import {bedData} from '../data/data.ts'
...
const Bedroom = () => {
  ...
  return (
    ...
    <div className='living2' onClick={handleShow}>
    ...
    <div className='showbox z-20'>
      ...
      <span className="box"></span>
        <div className="label">
          <p className="playfair-display-semibold text-lg tracking-wider">Bedroom Designs</p>
        </div>
       ...
       
          {
            ...
            <>
             ...
             style={{width:'500px' , transition:'width 3s ease'}}>
              {
                bedData.map((each :any,index:number) => (
